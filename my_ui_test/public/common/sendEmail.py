...
# 创建log对象
logger =Log(logger="sendEmail")
# 配置收发件人
recvaddress = ['164845216@qq.com']
# 163的用户名和密码
sendaddr_name = 'dalaopo7891@163.com'
sendaddr_pswd = 'babaya5201314'
...
class SendMail:
	...
	def __take_messages(self):
		...
		att1["Content-Disposition"] = 'attachment; filename="{0}"'.format(newreport)#这里的filename可以任意写，写什么名字，邮件中显示什么名字
